...
Игра "RogueLike" написана на Java 14 с использованием стандартных библиотек. Сама игра спроектирована в формате Rogue-like игр. В качестве интерфейса взаимодействия с пользователем используется консольная визуализация.  
